  ...
  return (
    <div className="relative flex flex-col lg:justify-between mb-36 lg:items-center lg:flex-row lg:pt-32 lg:mb-56">
      <div className="flex flex-col order-2 w-full px-8 -mt-3 text-center md:w-2/3 md:mx-auto lg:order-1 lg:text-left lg:w-7/12 lg:pl-8">
        ...
        <button className="w-2/3 px-3 py-4 mx-auto my-10 text-xl font-semibold tracking-wider rounded-full lg:my-4 lg:py-3 lg:mr-auto lg:ml-0 lg:w-1/3 btn">
          Get Started
        </button>
      </div>
      <div className="w-11/12 -mt-16 md:ml-auto lg:ml-0 lg:mt-0 lg:w-5/12 lg:order-2">
        <svg
          className="min-w-full transform scale-75 -translate-x-16 md:scale-90 md:translate-x-20 lg:absolute lg:top-10 lg:left-1/2 lg:scale-100 lg:ml-28 lg:translate-x-0"
