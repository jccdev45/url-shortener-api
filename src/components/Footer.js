export const Footer = () => {
  return (
    <footer className="flex flex-col items-center py-12 bg-neutral-darkViolet lg:flex-row lg:justify-evenly lg:items-start lg:pl-40 lg:pr-36 lg:pt-20 lg:pb-16">
      ...
      <div className="md:flex md:items-start md:justify-between lg:justify-end md:mx-auto md:w-2/3">
        <ul className="footer-link-container">
          <h2 className="footer-link-header">Features</h2>
      ...
      <ul className="flex items-center my-4 lg:my-0">
        <li className="mx-3 footer-link">
        ...
        <li className="mx-3 foooter-link">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
            <path
              fill="#FFF"
