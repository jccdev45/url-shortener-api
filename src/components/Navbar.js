...
export const Navbar = () => {
  ...
  return (
    <header className="relative top-0 z-20 flex flex-wrap items-center justify-between px-8 pt-12 pb-8 lg:flex-nowrap lg:py-0 lg:px-10">
      ...
      <MdMenu
        className="text-4xl text-neutral-gray lg:hidden"
        onClick={() => setIsMenu(!isMenu)}
      />
      <nav
        className={`${
          isMenu
            ? "flex bg-primary-darkViolet absolute top-20 left-0 mx-4 w-11/12"
            : "hidden"
        } my-2 lg:my-0 z-10 rounded-lg py-8 px-6 lg:p-0 items-center flex-col lg:justify-between lg:w-full lg:flex-row lg:inline-flex`}
      >
        ...
        <div className="flex flex-col items-center w-full pt-4 mt-4 border-t border-gray-400 lg:pt-0 lg:mt-0 border-opacity-30 lg:border-none lg:w-1/4 lg:flex-row">
          <button className="navlink">Login</button>
          <button className="w-full px-5 py-3 m-4 text-lg font-bold rounded-full lg:m-3 lg:text-sm btn">
            Sign Up
          </button>
        </div>
      </nav>
