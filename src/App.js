...
function App() {
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden font-serif">
      <div className="container flex flex-col mx-auto lg:px-12 lg:pt-8">
        <Navbar />
        <Hero />
      </div>
      <main className="flex flex-col flex-grow w-full mx-auto bg-gray-200">
        <div className="container p-6 mx-auto -mt-32 md:px-28 lg:px-20 lg:-mt-28">
          <ShortenerForm
            linkValue={linkValue}
            error={error}
          ...
          />
          {isLoading && (
            <h1 className="my-8 text-5xl italic text-center animate-bounce text-secondary-red">
              Loading
            </h1>
          )}
          {renderLinks()}
          ...
          <div className="p-2 mt-20 mb-16 text-center lg:mx-auto lg:w-1/2 lg:mb-12">
            ...
            <p className="leading-7 tracking-wider transform scale-105 text-neutral-grayViolet">
          ...
          <div className="flex flex-col mt-16 mb-10 lg:my-24 lg:h-96 lg:flex-row">
            ...
            <div className="relative z-30 flex flex-col px-8 py-10 my-12 bg-white rounded lg:mt-0 lg:mb-24">
              ...
              <h2 className="mt-10 mb-4 text-2xl font-semibold text-center transform scale-110 lg:text-left lg:scale-100">
                Brand Recognition
              </h2>
              <p className="leading-7 tracking-wide text-center lg:text-left text-neutral-grayViolet">
            ...
            {/* second */}
            <div className="relative z-20 flex flex-col px-8 py-10 my-12 bg-white rounded lg:mx-6">
              <div className="absolute left-0 grid w-full mt-4 md:-mt-4 lg:mt-0 -top-1/2 place-items-center lg:place-items-end lg:place-content-start">
                <div className="w-2 h-24 bg-primary-cyan lg:absolute lg:-left-6 lg:top-60 lg:transform lg:rotate-90 lg:h-10"></div>
                <div className="grid w-24 h-24 mx-auto rounded-full place-items-center bg-primary-darkViolet lg:ml-8 lg:mt-24">
                  <svg
            ...
            {/* third */}
            <div className="relative flex flex-col px-8 py-10 my-12 bg-white rounded lg:mb-0 lg:mt-24">
              <div className="absolute left-0 grid w-full mt-2 md:-mt-4 lg:mt-0 -top-1/2 place-items-center lg:place-items-end lg:place-content-start">
                <div className="w-2 h-24 bg-primary-cyan lg:absolute lg:-left-6 lg:top-48 lg:transform lg:rotate-90 lg:h-10"></div>
                <div className="grid w-24 h-24 mx-auto rounded-full place-items-center bg-primary-darkViolet lg:ml-8 lg:mt-24">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="48"
        ...
        <div className="w-screen px-6 mx-auto text-center bg-no-repeat bg-cover md:px-14 py-28 md:bg-boost-desktop lg:py-14 lg:bg-auto bg-primary-darkViolet bg-boost-mobile">
          <h2 className="text-2xl font-bold text-white transform scale-110 lg:scale-100 lg:text-4xl">
            Boost your links today
          </h2>
          <button className="w-7/12 px-5 py-4 my-4 text-xl font-bold rounded-full md:w-1/3 lg:w-1/6 lg:mb-0 lg:mt-8 btn">
            Get Started
          </button>
        </div>
      </main>
